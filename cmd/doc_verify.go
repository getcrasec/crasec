...
var (
	docVerifyCertIdentity        string
	docVerifyCertIdentityRegex   string
	docVerifyCertOIDCIssuer      string
	docVerifyCertOIDCIssuerRegex string
)

var docVerifyCmd = &cobra.Command{
	Use:   "verify <file> <file.sig>",
	Short: "Verify a Sigstore signature over an EU Declaration of Conformity file",
	Long: `Verify a Sigstore bundle produced by "crasec doc sign": checks the
...
func init() {
	...
	docVerifyCmd.Flags().StringVar(&docVerifyCertIdentity, "certificate-identity", "", "require the signing certificate SAN to equal this value")
	docVerifyCmd.Flags().StringVar(&docVerifyCertIdentityRegex, "certificate-identity-regex", "", "require the signing certificate SAN to match this regex")
	docVerifyCmd.Flags().StringVar(&docVerifyCertOIDCIssuer, "certificate-oidc-issuer", "", "require the signing certificate's OIDC issuer to equal this value")
	docVerifyCmd.Flags().StringVar(&docVerifyCertOIDCIssuerRegex, "certificate-oidc-issuer-regex", "", "require the signing certificate's OIDC issuer to match this regex")
}
...
func runDocVerify(cmd *cobra.Command, args []string) error {
	...
	if docVerifyCertIdentity != "" || docVerifyCertIdentityRegex != "" || docVerifyCertOIDCIssuer != "" || docVerifyCertOIDCIssuerRegex != "" {
		identity = &artifactsign.Identity{
			SAN:         docVerifyCertIdentity,
			SANRegex:    docVerifyCertIdentityRegex,
			Issuer:      docVerifyCertOIDCIssuer,
